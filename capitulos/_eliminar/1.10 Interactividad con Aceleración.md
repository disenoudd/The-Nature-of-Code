...
Volvamos a escribir lo anterior usando la sintaxis de `PVector`. Asumiendo que estamos en la clase Caminante y por lo tanto tenemos acceso al `PVector ubicacion`, entonces tenemos:
